...
import { Card, Button, Badge, Input, Modal, CardSkeleton, OAuthModal, KiroOAuthWrapper, CursorAuthModal, FreebuffAuthModal, XiaomiMimoAuthModal, IFlowCookieModal, GitLabAuthModal, Toggle, Select, EditConnectionModal, NoAuthProxyCard, ConfirmModal, LiveModelFetchModal } from "@/shared/components";
...
const ALLOWED_LIVE_FETCH_PROVIDERS = new Set([
  ...
  "cloudflare-ai",
  "api-airforce",
  // Built-in API key providers (integrated custom providers)
  "ramclouds",
  "seekai",
  "agentrouter",
  "vyceai",
...
export default function ProviderDetailPage() {
  ...
  const handleFetchLiveModels = handleOpenLiveFetchModal;
  const handleImportQoderModels = handleOpenLiveFetchModal;
  const handleImportClineModels = handleOpenLiveFetchModal;

...
export const KIND_EXAMPLE_CONFIG = {
  ...
  video: {
    inputLabel: "Prompt",
    inputPlaceholder: "A serene lake at sunset with mountains in the background",
    defaultInput: "A serene lake at sunset with mountains in the background",
    bodyKey: "prompt",
    defaultResponse: `{\n  "id": "...",\n  "status": "completed",\n  "video": {\n    "url": "http://..."\n  }\n}`,
    extraFields: [
      {
        ...
        type: "select",
        default: "640x368",
        options: ["640x368", "832x480", "480x832", "1280x720", "720x1280", "512x512"],
      },
      {
        key: "duration",
        label: "Duration",
      ...
      },
      {
        ...
        label: "Neg Prompt",
        type: "text",
        default: "blurry, low quality, static, distorted",
